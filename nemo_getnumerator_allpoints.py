...
Asum=sparse.load_npz(args.asumfile)

numsubj=chaco_allsubj.shape[0]
numvoxels=chaco_allsubj.shape[1]
numerator_chaco_allsubj=(chaco_allsubj.multiply(Asum))

mean_numerator_chaco_allsubj_allpoints=np.mean(numerator_chaco_allsubj,axis=0)
savemat(outfile,{'mean_numerator_chaco_allsubj_allpoints':mean_numerator_chaco_allsubj_allpoints})
