...
for i=24:47 %loop over subjects   
    ...
    save_avw(ICC_GSR_3D,strcat('/home/emo4002/colossus_shared3/pons_sfmodelling/results/ICC/SUB',num2str(i), '_ICC'),'f',[2 2 2 2]);
end
...
save('/home/emo4002/colossus_shared3/pons_sfmodelling/results/ICC/crtl_cat_GSR_mean.mat', 'ctrl_cat_GSR_mean')
save('/home/emo4002/colossus_shared3/pons_sfmodelling/results/ICC/crtl_cat_GSR_stdev.mat', 'ctrl_cat_GSR_stdev')
